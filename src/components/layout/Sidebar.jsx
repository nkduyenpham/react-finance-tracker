...
const Sidebar = () => {
    ...
    return (
        <nav className='h-screen p-5 shadow-sm border'>
            ...
            <div className='mt-3'>
                <Link to="/dashboard" className={`flex gap-2 mb-2 p-3 hover:bg-primary hover:text-white rounded-lg cursor-pointer ${isActive("/dashboard") ? "bg-primary text-white" : ""}`}>
                    <HomeIcon />
            ...
            <div className='text-sm pt-[800px]'>
                PERFIN. by Duyen Pham<br />@ 2024 all right reserved
            </div>
        </nav>
    );
};
